...
public class SecurityConfiguration {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
            ...
            .requestMatchers(POST, "/client/**").hasAuthority(CLIENT_CREATE.name())
            .requestMatchers(PUT, "/client/**").hasAuthority(CLIENT_UPDATE.name())
            .requestMatchers(DELETE, "/client/**").hasAuthority(CLIENT_DELETE.name())
            .requestMatchers("/client/**").hasRole(CLIENT.name())
            .requestMatchers(GET, "/client/**").hasAuthority(CLIENT_READ.name())
